...
fire_cascade = cv2.CascadeClassifier('F:/bbbbbbbbbbbbbbbbbbbbbbbbb/Fire-detection-with-AI-and-instant-multi-functional-response-system.-main/fire_detection_cascade_model.xml') # To access xml file which includes positive and negative images of fire. (Trained images)
...
def play_alarm_sound_function(): # defined function to play alarm post fire detection using threading
    playsound('F:/bbbbbbbbbbbbbbbbbbbbbbbbb/Fire-detection-with-AI-and-instant-multi-functional-response-system.-main/Fire_alarm.mp3',True) # to play alarm # mp3 audio file is also provided with the code.
